  ...
  return (
    <ul className="my-2 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6 ">
       ...
       <Typography
        ...
        variant="small"
        color="blue-gray"
        className="text-md text-black dark:text-gray-400 uppercase font-semibold mr-16"
      >
      ...
      <li>
              <Link
                to=""
                className={`text-md font-semibold text-left z-30 text-black uppercase hover:bg-gray-100 md:hover:bg-transparent md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:text-white md:dark:hover:bg-transparent ${
              ...
              {showCourseDropdown && (
                <ul className="absolute z-10 mt-2  bg-white border border-gray-300 rounded-lg shadow-lg dark:bg-gray-800">
                  <li>
                    <Link
                      to="/admincategory"
                      className="block w-full px-4 py-2 z-10 text-left text-black hover:bg-gray-100 dark:hover:bg-gray-700"
                    >
                      Category Table
                    </Link>
                  </li>
      ...
      <Typography
        ...
        variant="small"
        color="blue-gray"
        className="p-1 font-medium text-xl mr-10 text-black "
      >
...
export function AdminNavbar() {
  ...
  return (
    <Navbar className="mx-auto px-6 py-3 bg-white shadow-md w-full">
