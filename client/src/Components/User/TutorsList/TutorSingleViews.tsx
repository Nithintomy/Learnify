        ...
        <div className="grid items-center grid-cols-1 md:grid-cols-2">
            ...
            <div>
                <h2 className="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">Hey 👋 I am
                   <br />
                    <br className="block sm:hidden" />{tutorDetails?.tutorName}
                </h2>
                ...
                <p className="mt-4 text-sm text-gray-600 md:mt-8">
                    ...
                    <br />
                    <button  className="btn btn-active btn-accent mt-5 text-sm font-medium text-white rounded-md">Buy Our Course</button>
            ...
            <div className="relative ">
                ...
                <img className="relative w-72 rounded-badge  h-2/3 xl:max-w-lg xl:mx-auto 2xl:origin-bottom 2xl:scale-110" src={tutorDetails.photo} alt={tutorDetails.tutorName} />
                   </div>
